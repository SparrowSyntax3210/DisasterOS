...
async function getPrediction(latitude, longitude) {
...
async function getMapResources(latitude, longitude) {
  return apiRequest(
...
async function createSOS(payload) {
  return apiRequest("/sos", {
    method: "POST",
...
async function updateSOS(id, payload) {
...
async function getPredictionHistory() {
  return apiRequest("/predictions/history/all");
}
