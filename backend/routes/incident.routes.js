  ...
  try {
    ...
    if (
      ...
      return res.status(400).json({
        success: false,
        message:
          "Incident ID, type, severity, latitude and longitude are required.",
      });
    }
    ...
    socketService.broadcast("incident:created", {
      incident,
    });
...
router.patch("/:id", async (req, res) => {
  try {
    ...
    socketService.broadcast("incident:updated", {
      incident,
    });
...
router.delete("/:id", async (req, res) => {
  try {
    ...
    socketService.broadcast("incident:deleted", {
